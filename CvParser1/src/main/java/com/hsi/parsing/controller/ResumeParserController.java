...
import com.hsi.parsing.service.ICandidateservice;
...
public class ResumeParserController {
	...
	@RequestMapping(value = "/displayAllCandidateDetails")
	public ResponseEntity<List<CandidateInfo>> uploadCV() throws IOException {
